...
describe Sentence do
  ...
  describe "Validate translate" do
    ...
    before {
      @sentence = FactoryGirl.create(:sentence, :practice => @practice_1, :subject => 'We can go')
      @sentence_translation_1 = FactoryGirl.create(:sentence_translation, 
        :sentence => @sentence,
        :subject => "podemos ir"
      )
    ...
    describe "Without additional spaces among words" do
      before {
        @subject_1 = "nosotros podemos ir"
        @subject_2 = 'nosotras podemos ir'
      }
  ...
  describe "Validate translate" do
    ...
    before {
      @sentence = FactoryGirl.create(:sentence, :practice => @practice_1, :subject => 'They can go')
      @sentence_translation_1 = FactoryGirl.create(:sentence_translation, 
        :sentence => @sentence,
        :subject => "ellos pueden ir"
      )
    ...
    describe "Without additional spaces among words" do
      before {
        @subject_1 = "pueden ir"
        @subject_2 = 'ellas pueden ir'
        @subject_3 = 'pueden ellas ir'
        @subject_4 = 'pueden ir ellos'
      }
